...
<body>
	<h2>request 알아보기</h2>
	<hr>
	<p>jsp 에서 HttpServletRequest 타입은 request 요청 객체는 선언하지 않고</p>
	<p>바로 사용할 수 있도록 내장(embeded) 객체로 만들어졌습니다.</p>
	<p>보내는 요청과 관련된 정보를 저장(속성)하고 있습니다.</p>
	<ul>
	...
	<hr>
	<!-- 서버 입장에서는 클라이언트가 remote, 서버 자신은 local -->
	<ul>
	...
	- 왼쪽에서 Apache Tomcat 에서 Tomact 항목 선택
	- 해당 실행 설정에서 Arguments 탭 클릭
	- VM arguments 에 다음 추가 : -Djava.net.preferIPv4Stack=true
	-->
	<hr>
	<ul>
